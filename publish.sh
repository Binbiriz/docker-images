...
# Dockerfile: dockerfiles/u1804-p74-n10-c233.Dockerfile
bash build-push.sh "binbiriz" "drupal" "u1804-p74-n10-c233" "ubuntu-18.04-php7.4" "node10"
...
# Dockerfile: dockerfiles/u1804-p80-nna-c2212.Dockerfile
bash build-push.sh "binbiriz" "drupal" "u1804-p80-nna-c2212" "ubuntu-18.04-php8.0" "nonode"
bash create-specs.sh "binbiriz" "drupal" "u1804-p80-nna-c2212" "ubuntu-18.04-php8.0" "nonode" "FALSE"
